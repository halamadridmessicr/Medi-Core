...
function showFinalDiagnosis(){
    ...
    if(disease.emergencyLevel==="Moderate")
        color="#f39c12";

    if(disease.emergencyLevel==="High")
        color="#e74c3c";
    ...
    <div class="moduleCard diagnosisCard">
        ...
        It is intended for educational assistance only and must not replace
        professional medical consultation.

        Please consult a qualified healthcare professional before taking any medication or medical decision.
